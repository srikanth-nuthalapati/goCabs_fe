    ...
    <header className="header w-full text-white bg-black p-4">
        <nav className="nav flex items-center text-sm font-semibold">
            ...
            <ul className='flex gap-1'>
                ...
                <li className='flex items-center py-[3px] px-[12px] cursor-pointer hover:bg-[#776464bb] rounded-[30px]'>Log in</li>
                <button className='flex items-center py-[3px] px-[12px] bg-white text-black cursor-pointer hover:bg-[rgba(255,255,255,0.9)] rounded-[30px]' >Sign up</button>
            </ul>
        </nav>
    </header>
    </>
